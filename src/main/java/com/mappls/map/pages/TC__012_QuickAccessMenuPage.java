...
public class TC__012_QuickAccessMenuPage {
	
	public TC__012_QuickAccessMenuPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath="//android.widget.ImageButton")
	public @Getter WebElement postMapCloseBtn;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_title\"]")
	public @Getter WebElement wlcmMapplsPageQA;
	
	@FindBy(xpath="//android.widget.ImageView[@resource-id=\"com.mmi.maps:id/image_view_back\"]")
	public @Getter WebElement qcArrowIcon;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_title\"]")
	public @Getter WebElement wlcmMapdplsPageQA;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/category_name\" and @text=\"Anything\"]")
	public @Getter WebElement anythingClick;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/sub_category_name_text_view1\"]")
	public @Getter WebElement postMapHedrTxt;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_location_value\"]")
	public @Getter WebElement chseLocationTxt;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/title\"]")
	public @Getter WebElement postMapPostedTxt;
	
	@FindBy(xpath="(//android.widget.LinearLayout[@resource-id=\"com.mmi.maps:id/linear_layout_1\"])[2]")
	public @Getter WebElement pstdEventClick;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/category_name\" and @text=\"Anything\"]")
	public @Getter WebElement pstEvntAnything;
	
	@FindBy(xpath="//android.widget.EditText[@resource-id=\"com.mmi.maps:id/search_input\"]")
	public @Getter WebElement pstEvntAnythingHeader;
	
//
	@FindBy(xpath="//android.widget.ImageButton[@resource-id=\"com.mmi.maps:id/search_filter\"]")
	public @Getter WebElement filtrClick;
	
	@FindBy(xpath="//android.widget.TextView[@text=\"Filter\"]")
	public @Getter WebElement fltrClckHeaderTxt;
	
	@FindBy(xpath="//android.widget.CheckedTextView[@resource-id=\"com.mmi.maps:id/item_filter_menu_txt\" and @text=\"Sort\"]")
	public @Getter WebElement pstEvntSort;
	
	@FindBy(xpath="//android.widget.CheckedTextView[@resource-id=\"com.mmi.maps:id/item_filter_options_txt\" and @text=\"Newest\"]")
	public @Getter WebElement pstEvntSortByNewst;
	
	@FindBy(xpath="//android.widget.Button[@resource-id=\"com.mmi.maps:id/filter_apply_btn\"]")
	public @Getter WebElement pstEvntSortByNwstApplyBtn;
	
	               //android.widget.TextView[@resource-id="com.mmi.maps:id/item_date" and @text="moments ago"]
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/item_date\"]")
	public @Getter WebElement momentsAgo; //moments ago
	
	@FindBy(xpath="//android.widget.TextView[@text=\"Post\"]")
	public @Getter WebElement postBtn;
//	
	@FindAll({@FindBy(id="com.mmi.maps:id/item_title")})
	public @Getter List<WebElement> pstEvntAddrsLists;
//	
	

	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_title\"]")
	public @Getter WebElement postMapPopUpMsgWOLTxt;
	
	@FindBy(xpath="//android.widget.Button[@resource-id=\"android:id/button2\"]")
	public @Getter WebElement postMapCancelLoginBtn;
	
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/sub_category_name_text_view1\"]")
	public @Getter WebElement afterClickCancelLogin;
	
	@FindBy(xpath="//android.widget.Button[@resource-id=\"android:id/chooser_copy_button\"]")
	public @Getter WebElement shareLinkCopyBtn;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_title\"]")
	public @Getter WebElement mpplsCamera;
	
	@FindBy(xpath="//android.widget.Button[@resource-id=\"com.android.permissioncontroller:id/permission_allow_button\"]")
	public @Getter WebElement imgMediaAllow;
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/my_saves_text_view\" and @text=\"Contributions\"]")
	public @Getter WebElement msContributionClick;
	
	
	@FindBy(xpath="(//android.widget.TextView[@resource-id=\"com.mmi.maps:id/item_world_view_status_text_view\"])[1]")
	public @Getter WebElement msCntriMapIssue;
	
	
	@FindBy(xpath="//android.widget.TextView[@resource-id=\"com.mmi.maps:id/text_view_distance\" and @text=\"moments ago\"]")
	public @Getter WebElement momentAgo;
...
//    public List<WebElement> postMapSelCategory;
	...
	@FindBy(xpath="//android.widget.ImageView[@resource-id=\"com.mmi.maps:id/image_view_take_picture\"]")
...
//	================
	...
	@FindBy(xpath = "//*[@class='android.widget.TextView' and contains(@text, 'Please select location')]")
	public @Getter WebElement toastMsg;

	
//	@FindBy(xpath = "//android.widget.Toast[@text=\"Please select location first\"]")
//	public @Getter WebElement toastMsg;	
